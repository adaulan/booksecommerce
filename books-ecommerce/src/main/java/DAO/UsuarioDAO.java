...
public class UsuarioDAO {
    ...
    public static boolean inserir(Usuario usuario)
        ...
        String sql = "INSERT INTO USUARIO (STATUS, NOME,USUARIO,SENHA,EMAIL,TIPO,DATANASC,CELULAR,CPF) VALUES (?,?,?,?,?,?,?,?,?)";
    ...
    public static List<Usuario> buscar(String busca)
        ...
        String sql = "SELECT * FROM USUARIO WHERE (STATUS != 'I' AND NOME  LIKE  ?) or (STATUS != 'I' AND STATUS LIKE ?)"
                + " or (STATUS != 'I' AND USUARIO LIKE ?)or (STATUS != 'I' AND EMAIL  LIKE  ?) or (STATUS != 'I' AND TIPO LIKE ?)"
                + " or (STATUS != 'I' AND DATANASC LIKE ?) or (STATUS != 'I' AND CELULAR LIKE ?) or (STATUS != 'I' AND CPF LIKE ?)";
        busca = '%' + busca + '%';
        ...
        try {
            ...
            while (result.next()) {
                ...
                Usuario U = new Usuario(ID, Status, Nome, Usuario, Senha, Email, Tipo, DataNasc, Celular, CPF);
    ...
    public static Usuario getByID(int ID)
        ...
        try {
            ...
            while (result.next()) {
                ...
                Usuario U = new Usuario(IDUsuario, Status, Nome, Usuario, Senha, Email, Tipo, DataNascimento, Celular, CPF);
                //Adiciona a instância no objeto
                usuario = U;
            }
        } catch (Exception e) {
            e.getLocalizedMessage();
    ...
    public static boolean atualizar(Usuario usuario)
        ...
        String sql = "UPDATE USUARIO SET STATUS=?, NOME=?, USUARIO=?, SENHA=?, EMAIL=?, TIPO=?, DATANASC=?, CELULAR=?, "
                + "CPF=? WHERE ID = ?";
        //Conexão para abertura e fechamento
        Connection connection = null;
        //Statement para obtenção através da conexão, execução de
